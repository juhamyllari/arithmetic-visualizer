...
public class ArrayIOUtilsTest {
    ...
    @Test(expected = BadArrayException.class)
    public void stringToRowThrowsBadArrayExceptionOnEmptyRow() throws BadArrayException {
        stringToRow("  ");
    }
    ...
    @Test(expected = BadArrayException.class)
    public void stringToArrayThrowsBadArrayExceptionIfThereAreNoRows() throws BadArrayException {
        stringToArray(" ; ");
    }
